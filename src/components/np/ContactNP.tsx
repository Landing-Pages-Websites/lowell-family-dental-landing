      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
        <div className="lg:col-span-6 text-white">
          ...
          <Reveal delay={80}>
            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-[1.1]">
              Same-week appointments. No phone tag. No pressure.
            </h2>
          </Reveal>
          <Reveal delay={140}>
            <p className="mt-5 text-lg text-white/85 leading-relaxed">
              Tell us a little about you and we&rsquo;ll call you back the same day to confirm
              a time. We&rsquo;ll verify your insurance ahead of time so there are no surprises
              at the front desk.
            </p>
          </Reveal>
        ...
        <Reveal variant="right" delay={140} className="lg:col-span-6">
          <LeadForm
            ...
            subhead="Takes 30 seconds. We'll call back the same day to confirm a time and verify your insurance."
